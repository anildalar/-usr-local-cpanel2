...
#define CONFIGURE_COMMAND " './configure'  '--prefix=/usr/local/cpanel/3rdparty/php/83' '--with-libdir=lib64' '--with-libdir=lib/x86_64-linux-gnu' '--verbose' '--enable-static' '--with-iconv' '--enable-mbstring' '--enable-gd' '--enable-mbregex' '--with-imap-ssl' '--with-imap=/usr/local/cpanel/3rdparty/lib64/imap/' '--enable-ftp' '--with-gettext' '--enable-sockets' '--enable-cgi' '--enable-fpm' '--with-pdo-mysql=mysqlnd' '--with-mysql-sock=/var/lib/mysql/mysql.sock' '--with-mysqli=mysqlnd' '--with-pgsql=/usr/local/cpanel/3rdparty' '--with-pdo-pgsql=/usr/local/cpanel/3rdparty' '--with-openssl=/usr' '--with-kerberos' '--with-curl=/usr' '--with-tidy=/usr/local/cpanel/3rdparty' '--with-config-file-path=/usr/local/cpanel/3rdparty/php/83/etc' '--with-jpeg=/usr' '--enable-intl' '--with-xpm=/usr' '--with-freetype=/usr/include/freetype2' '--with-bz2=/usr' '--with-zip' '--with-zlib' '--enable-soap' '--with-pear' '--enable-bcmath' '--with-xsl' '--enable-pcntl' '--with-ldap' '--with-ldap-sasl' '--enable-sysvsem' '--enable-sysvshm' '--with-xmlrpc' 'PKG_CONFIG_PATH=/usr/local/cpanel/3rdparty/lib64/pkgconfig' 'KERBEROS_CFLAGS=-I/usr/include' 'KERBEROS_LIBS=-L/usr/lib/x86_64-linux-gnu' 'JPEG_CFLAGS=-I/usr/include' 'JPEG_LIBS=-L/usr/lib/x86_64-linux-gnu -ljpeg' 'ONIG_CFLAGS=-I/usr/include/' 'ONIG_LIBS=-L/usr/lib/x86_64-linux-gnu/ -lonig'"
